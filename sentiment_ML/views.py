    ...
    def post(self, request):
        ...
        try:
            ...
            if tweets is None or tweets == '':
                ...
                vectoriser, model = load_model('D:/Arena Files/Arena Project/mlwithdjango/models/vectoriser.pickle', 'D:/Arena Files/Arena Project/mlwithdjango/models/Sentiment-LR.pickle')
